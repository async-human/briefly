...
class LLMAdapter:
    ...
    async def complete(
        ...
        *,
        ...
        if provider == "anthropic":
            return await self._anthropic(messages, system=system, model=_model, temperature=_temp, max_tokens=_max)
    ...
    async def complete_json(
        ...
        *,
        ...
        """
        resp = await self.complete(messages, system=system, model=model, json_mode=True)
